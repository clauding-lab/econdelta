...
| derived (cross-source) | `total_bank_advances` | `amount_bdt_crore` | fiscal_year | — | — | Total loans and advances of the banking sector — from BB FSR Table 2.3 via scrapers/bb_npl_structure.py (annual). |
